...
{
    public class ExtendedSinglePipelineData
    {
    ...
    {
        public ExtendedSinglePipelineData attributes { get; set; } = null!;
    }
    ...
    public class EsriExtendedSinglePipelineResponse
    {
    ...
    public class ExtendedSinglePipelineDataList
    {
        public List<ExtendedSinglePipelineData>? SinglePipelineData { get; set; }
        public bool ExceededTransferLimit { get; set; }
