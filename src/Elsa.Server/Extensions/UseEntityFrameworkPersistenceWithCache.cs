...
namespace Elsa.Server.Extensions
{
    public static class EntityFrameworkPersistenceExtensions
    {
        ...
        public static ElsaOptionsBuilder UseEntityFrameworkPersistenceWithCache(this ElsaOptionsBuilder elsa,
            Action<DbContextOptionsBuilder> configure,
            bool autoRunMigrations = true, bool useCache = false) =>
            elsa.UseEntityFrameworkPersistenceWithCache<ElsaContext>(configure, autoRunMigrations, useCache);
        ...
        /// <returns>The Elsa options builder, so calls may be chained</returns>
        public static ElsaOptionsBuilder UseEntityFrameworkPersistenceWithCache<TElsaContext>(this ElsaOptionsBuilder elsa,
            Action<DbContextOptionsBuilder> configure,
            bool autoRunMigrations = true, bool useCache = true) where TElsaContext : ElsaContext =>
            elsa.UseEntityFrameworkPersistenceWithCache<TElsaContext>((_, builder) => configure(builder), autoRunMigrations, useCache);
        ...
        public static ElsaOptionsBuilder UseEntityFrameworkPersistenceWithCache(this ElsaOptionsBuilder elsa,
            ...
            bool autoRunMigrations = true, bool useCache = true) =>
            elsa.UseEntityFrameworkPersistenceWithCache<ElsaContext>(configure, autoRunMigrations);
        ...
        public static ElsaOptionsBuilder UseEntityFrameworkPersistenceWithCache<TElsaContext>(this ElsaOptionsBuilder elsa,
            Action<IServiceProvider, DbContextOptionsBuilder> configure,
            bool autoRunMigrations = true, bool useCache = true) where TElsaContext : ElsaContext =>
            UseEntityFrameworkPersistenceWithCache<TElsaContext>(elsa, configure, autoRunMigrations, useCache, true, ServiceLifetime.Singleton);
        ...
        public static ElsaOptionsBuilder UseNonPooledEntityFrameworkPersistence(this ElsaOptionsBuilder elsa,
            Action<IServiceProvider, DbContextOptionsBuilder> configure,
            ServiceLifetime serviceLifetime = ServiceLifetime.Singleton,
            bool autoRunMigrations = false, bool useCache = true) =>
            elsa.UseNonPooledEntityFrameworkPersistence<ElsaContext>(configure, serviceLifetime, autoRunMigrations, useCache);
        ...
        public static ElsaOptionsBuilder UseNonPooledEntityFrameworkPersistence<TElsaContext>(this ElsaOptionsBuilder elsa,
            Action<IServiceProvider, DbContextOptionsBuilder> configure,
            ServiceLifetime serviceLifetime = ServiceLifetime.Singleton,
            bool autoRunMigrations = false, bool useCache = true) where TElsaContext : ElsaContext =>
            UseEntityFrameworkPersistenceWithCache<TElsaContext>(elsa, configure, autoRunMigrations, useCache, false, serviceLifetime);

        static ElsaOptionsBuilder UseEntityFrameworkPersistenceWithCache<TElsaContext>(ElsaOptionsBuilder elsa,
            Action<IServiceProvider, DbContextOptionsBuilder> configure,
