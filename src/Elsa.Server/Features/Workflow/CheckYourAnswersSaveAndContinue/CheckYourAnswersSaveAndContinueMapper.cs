...
{
    public interface ICheckYourAnswersSaveAndContinueMapper
    {
        CustomActivityNavigation saveAndContinueCommandToNextCustomActivityNavigation(CheckYourAnswersSaveAndContinueCommand command, string nextActivityId, string nextActivityType, WorkflowInstance workflowInstance);
    ...
    public class CheckYourAnswersSaveAndContinueMapper : ICheckYourAnswersSaveAndContinueMapper
    {
        private readonly IDateTimeProvider _dateTimeProvider;

        public CheckYourAnswersSaveAndContinueMapper(IDateTimeProvider dateTimeProvider)
        {
            _dateTimeProvider = dateTimeProvider;
        }

        public CustomActivityNavigation saveAndContinueCommandToNextCustomActivityNavigation(CheckYourAnswersSaveAndContinueCommand command, string nextActivityId, string nextActivityType, WorkflowInstance workflowInstance)
        {
