    ...
    public class CreateOverrideCommandHandlerTests
    {
        ...
        )
        {
            ...
            assessmentToolWorkflowHelper
                .Setup(x => x.IsOrderEqualToLatestSubmittedWorkflowOrder(instance)).ReturnsAsync(true);
        ...
        )
        {
            ...
            assessmentToolWorkflowHelper
                .Setup(x => x.IsOrderEqualToLatestSubmittedWorkflowOrder(instance)).ReturnsAsync(false);
