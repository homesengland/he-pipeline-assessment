    ...
    QuestionScreenSaveAndContinueCommand saveAndContinueCommand)
        {
            ...
            {
                Answers = saveAndContinueCommand.Data.QuestionScreenAnswers?.SelectMany(x => x.Answers.Select(y => new Answer(x.QuestionId, y.AnswerText, x.Comments, y.ChoiceId))).ToList(),
