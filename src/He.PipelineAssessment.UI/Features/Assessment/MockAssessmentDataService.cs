...
//        public AssessmentSummaryResponse GetData(AssessmentSummaryRequest request)
//        {
//            return GetSummaryDummyData(request.AssessmentId, request.CorrelationId);
//        }

//        private AssessmentSummaryResponse GetSummaryDummyData(int id, int correlationId)
//        {
...
//        private IEnumerable<AssessmentSummaryStage> GetStages()
//        {
//            return new List<AssessmentSummaryStage>
//           {
