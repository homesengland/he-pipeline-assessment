...
{
    public class CreateAmmendmentRequestHandler : IRequestHandler<CreateAmmendmentRequest, AssessmentInterventionDto>
    {
        ...
        public CreateAmmendmentRequestHandler(IAssessmentRepository assessmentRepository,
        ...
        public async Task<AssessmentInterventionDto> Handle(CreateAmmendmentRequest request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var dtoConfig = new DtoConfig()
                {
                    UserName = userName,
                    UserEmail = email,
                    DecisionType = InterventionDecisionTypes.Ammendment,
