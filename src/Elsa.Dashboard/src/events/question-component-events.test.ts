...
it('onTitleChanged should emit an event with updated title on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
  ...
  it('onIdentifierChanged should emit an event with updated id on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
    let question = new Question();
  ...
  it('onQuestionChanged should emit an event with updated question text on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
    let question = new Question();
  ...
  it('onGuidanceChanged should emit an event with updated guidance on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
    let question = new Question();
  ...
  it('onHintChanged should emit an event with updated hint on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
    let question = new Question();
  ...
  it('onDisplayCommentsBox should emit an event with updated displayCommentsBox on standard question', () => {
    const EventEmitter = require("events");
    const emitter = new EventEmitter()
    emitter.emit = jest.fn();
    let question = new Question();
