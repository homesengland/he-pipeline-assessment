...
//import { IconProvider, IconColor, IconName } from "../../icon-provider/icon-provider";

//@Component({
//  tag: 'he-dictionary-property',
//  shadow: false,
//})
//  //Copy of Elsa Switch Case
//  //Copied to allow us control over how the expression editor is displayed.
//export class HEDictionaryProperty {
...
//    const newValue = this.currentValue.filter((_x, i) => i !== index);
...
//                  {this.iconProvider.getIcon(IconName.TrashBinOutline, { color: IconColor.Gray, hoverColor: IconColor.Red })}
//                </button>
//                {isLast && <button type="button" onClick={this.onRowAdded}>
//                  {this.iconProvider.getIcon(IconName.Plus, { color: IconColor.Gray, hoverColor: IconColor.Green })}
//                </button>}
//              </div>
//            </div>
//          );
...
//Tunnel.injectProps(HEDictionaryProperty, ['serverUrl']);
