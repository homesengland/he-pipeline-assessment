...
export class HeDictionaryDriver implements HePropertyDisplayDriver {
  ...
  displayNested(activity: ActivityModel, property: HeProperty, onExpressionChanged: Function) {
    ...
    return <he-dictionary-property activityModel={activity} propertyDescriptor={property.descriptor} propertyModel={prop.value} onExpressionChanged={e => onExpressionChanged(e, property)} />;
  }
}
