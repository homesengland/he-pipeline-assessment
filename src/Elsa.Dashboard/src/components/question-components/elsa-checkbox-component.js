...
let ElsaCheckboxComponent = class ElsaCheckboxComponent {
    constructor() {
    ...
    async componentWillLoad() {
        if (this.question && !this.question.checkbox) {
            this.question.checkbox = new QuestionOptions();
        }
        ...
        const renderChoiceEditor = (multiChoice, index) => {
            ...
            return (h("tr", { key: `choice-${index}` },
                ...
                h("td", { class: "elsa-py-0" },
                    h("input", { id: `${field}-id`, name: "choice_input", type: "checkbox", checked: isChecked, value: 'true', onChange: e => this.handler.onCheckChanged.bind(this)(e, multiChoice), class: "focus:elsa-ring-blue-500 elsa-h-8 elsa-w-8 elsa-text-blue-600 elsa-border-gray-300 elsa-rounded" })),
                ...
                h("table", { class: "elsa-min-w-full elsa-divide-y elsa-divide-gray-200" },
                    h("thead", { class: "elsa-bg-gray-50" },
                        h("tr", null,
                            ...
                            h("th", { class: "elsa-py-3 elsa-text-left elsa-text-xs elsa-font-medium elsa-text-gray-500 elsa-tracking-wider elsa-w-8/12" }, "Answer"),
                    ...
                    h("tbody", null, this.question.checkbox.choices.map(renderChoiceEditor))),
...
__decorate([
    Prop()
], ElsaCheckboxComponent.prototype, "question", void 0);
__decorate([
    State()
], ElsaCheckboxComponent.prototype, "iconProvider", void 0);
__decorate([
    Event({
...
], ElsaCheckboxComponent.prototype, "updateQuestion", void 0);
ElsaCheckboxComponent = __decorate([
    Component({
        tag: 'elsa-checkbox-question',
        shadow: false,
    })
], ElsaCheckboxComponent);
export { ElsaCheckboxComponent };
