...
// Removed AxiosInstance import; using fetch wrapper instead
...
export class ElsaStudioRoot {
  ...
  const httpClientFactory: () => Promise<(input: string, init?: RequestInit) => Promise<Response>> = () => createHttpClient(this.serverUrl);
