...
const ElsaMultiLineProperty = class {
    ...
    render() {
        ...
        return (h("elsa-property-editor", { key: 'aebee49160f49d7beaef41fab6a239b46d299772', activityModel: this.activityModel, propertyDescriptor: propertyDescriptor, propertyModel: propertyModel, onDefaultSyntaxValueChanged: e => this.onDefaultSyntaxValueChanged(e), "editor-height": editorHeight.propertyEditor, context: context }, h("textarea", { key: '98df983dc1fbe2eaf4e6896cd47a2dc38ed22ca1', id: fieldId, name: fieldName, value: value, onChange: e => this.onChange(e), class: "focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-block elsa-w-full elsa-min-w-0 elsa-rounded-md sm:elsa-text-sm elsa-border-gray-300", rows: editorHeight.textArea })));
    }
};

export { ElsaMultiLineProperty as elsa_multi_line_property };
//# sourceMappingURL=elsa-multi-line-property.entry.esm.js.map
