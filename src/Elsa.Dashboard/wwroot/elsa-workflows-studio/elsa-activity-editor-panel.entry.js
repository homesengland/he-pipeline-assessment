...
const ElsaActivityEditorPanel = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return (h("form", { key: '42a66eceddb3c0554f1fb73b08bb481b7e31cbbf', onChange: this.onChange, ref: el => this.formElement = el }, h("elsa-flyout-panel", { key: 'ee539d5c74484c1e5ef982ec4fffaf698cb38935', autoExpand: true, silent: true, updateCounter: this.updateCounter }, tabs.map(tab => [
...
//# sourceMappingURL=elsa-activity-editor-panel.entry.esm.js.map
