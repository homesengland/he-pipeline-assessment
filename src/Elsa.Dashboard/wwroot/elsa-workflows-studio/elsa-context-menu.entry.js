...
const ElsaContextMenu = class {
    ...
    render() {
        return (h("div", { key: '7616977563525d3c0982479ff2f1a5431281402d', class: "elsa-relative elsa-flex elsa-justify-end elsa-items-center", ref: el => this.element = el }, h("button", { key: '3761534118211012cc8cbae4f0017e7e59990fec', onClick: () => this.toggleMenu(), "aria-has-popup": "true", type: "button", class: "elsa-w-8 elsa-h-8 elsa-inline-flex elsa-items-center elsa-justify-center elsa-text-gray-400 elsa-rounded-full elsa-bg-transparent hover:elsa-text-gray-500 focus:elsa-outline-none focus:elsa-text-gray-500 focus:elsa-bg-gray-100 elsa-transition elsa-ease-in-out elsa-duration-150" }, h("svg", { key: '68fe400628d3ed63126674c5dbe40ba26ceb8cc4', class: "elsa-w-5 elsa-h-5", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" }, h("path", { key: 'd6cc6051aaac7dde35269c7eca45b28f56918491', d: "M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z" }))), h("div", { key: '6ea9a5f26596a286edb73742e56b58cfefa7209f', ref: el => this.contextMenu = el, "data-transition-enter": "elsa-transition elsa-ease-out elsa-duration-100", "data-transition-enter-start": "elsa-transform elsa-opacity-0 elsa-scale-95", "data-transition-leave": "elsa-transition elsa-ease-in elsa-duration-75", "data-transition-leave-start": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave-end": "elsa-transform elsa-opacity-0 elsa-scale-95", class: "hidden elsa-z-10 elsa-mx-3 elsa-origin-top-right elsa-absolute elsa-right-7 elsa-top-0 elsa-w-48 elsa-mt-1 elsa-rounded-md elsa-shadow-lg" }, h("div", { key: 'a6594a58faa0343777b7de7de2613c862c2bcef1', class: "elsa-rounded-md elsa-bg-white elsa-shadow-xs", role: "menu", "aria-orientation": "vertical", "aria-labelledby": "project-options-menu-0" }, this.menuItems.map(menuItem => {
...
//# sourceMappingURL=elsa-context-menu.entry.esm.js.map
