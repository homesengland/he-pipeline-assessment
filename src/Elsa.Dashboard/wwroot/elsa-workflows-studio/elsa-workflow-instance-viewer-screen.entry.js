...
import { b as WorkflowStatus, a as WorkflowPersistenceBehavior, S as SyntaxNames } from './index-D7wXd6HU.js';
...
const ElsaWorkflowInstanceViewerScreen = class {
    ...
    mapActivityModel(activityBlueprint, workflowInstance) {
        ...
        const properties = collectionExports.map(activityBlueprint.inputProperties.data, (value, key) => {
    ...
    render() {
        ...
        return (h(Host, { key: '54f48391ea948ca957386f6dbd818fb566f7111d', class: "elsa-flex elsa-flex-col elsa-w-full elsa-relative", ref: el => this.el = el }, this.renderCanvas(), h("elsa-workflow-instance-journal", { key: 'e29c73b1f97cbbcd8e636e6bc9545f2125c5679b', ref: el => this.journal = el, workflowInstanceId: this.workflowInstanceId, workflowInstance: this.workflowInstance, serverUrl: this.serverUrl, activityDescriptors: descriptors, workflowBlueprint: this.workflowBlueprint, workflowModel: this.workflowModel, onRecordSelected: e => this.onRecordSelected(e) })));
    }
    renderCanvas() {
...
//# sourceMappingURL=elsa-workflow-instance-viewer-screen.entry.esm.js.map
