...
import { F as FormContext, t as textInput, b as textArea, c as checkBox } from './forms-CaCATBuQ.js';
...
const ElsaWebhookDefinitionEditorScreen = class {
    constructor(hostRef) {
    ...
    render() {
        return (h(Host, { key: '270df810dbf7aef39882a89b2a53f1676f754dd3', class: "elsa-flex elsa-flex-col elsa-w-full", ref: el => this.el = el }, h("form", { key: 'bd2a95ccd3c7952b505741ddaffb69c2fe8f4e71', onSubmit: e => this.onSaveClicked(e) }, h("div", { key: 'da6ac147175d6d1dddc3d1bde2accc357ce5cbbe', class: "elsa-px-8 mb-8" }, h("div", { key: 'ad2a605d6e9a09f8a09786843de7b464c8ee3b13', class: "elsa-border-b elsa-border-gray-200" })), this.renderWebhookFields(), this.renderCanvas())));
    }
    renderWebhookFields() {
...
//# sourceMappingURL=elsa-webhook-definition-editor-screen.entry.esm.js.map
