...
import { E as EditorVariables, i as initializeMonacoWorker } from './elsa-monaco-utils-BNFq3u5d.js';
import { a as state } from './store-B_H_ZDGs.js';

const elsaMonacoCss = ".elsa-monaco-editor-host{display:block;position:relative;min-height:6em}.elsa-monaco-editor-container{position:absolute;left:0;top:0;width:100%;height:100%;max-height:100% !important;margin:0;padding:0}.elsa-monaco-editor{border-radius:0.25rem}.elsa-monaco-editor .overflow-guard{border-radius:0.25rem}.elsa-monaco-editor .suggest-widget div.tree{white-space:unset;padding-bottom:0}";
...
const ElsaMonaco = class {
    ...
    render() {
        ...
        return (h(Host, { key: '42f474c6717eb094f637677b89df108a2e9703af', class: "elsa-monaco-editor-host elsa-border focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-block elsa-w-full elsa-min-w-0 elsa-rounded-md sm:elsa-text-sm elsa-border-gray-300 elsa-p-4", style: { 'min-height': this.editorHeight } }, h("div", { key: '3f9fd623ee7f32e39b1d07160f8d543c41f1a4a4', ref: el => this.container = el, class: `elsa-monaco-editor-container ${padding}` })));
    }
...
//# sourceMappingURL=elsa-monaco.entry.esm.js.map
