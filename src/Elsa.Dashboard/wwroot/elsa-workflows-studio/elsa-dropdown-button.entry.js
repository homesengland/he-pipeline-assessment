...
const ElsaContextMenu = class {
    ...
    render() {
        return (h("div", { key: '7871e847b2698c5bd887afbe77954940ba9a03a0', class: "elsa-relative", ref: el => this.element = el }, h("button", { key: '260cfa3be94b8213812b00cd19080a62b700fc35', onClick: e => this.toggleMenu(), type: "button", class: this.btnClass, "aria-haspopup": "true", "aria-expanded": "false" }, this.renderIcon(), this.text, h("svg", { key: '9f9871a0e8bf6b3cb33aab59eb9f49fc21ace979', class: "elsa-ml-2.5 -elsa-elsa-mr-1.5 elsa-h-5 elsa-w-5 elsa-text-gray-400", "x-description": "Heroicon name: chevron-down", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, h("path", { key: '15c1e82b3f232d3f8244e775cfea271b2582c5fe', "fill-rule": "evenodd", d: "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z", "clip-rule": "evenodd" }))), this.renderMenu()));
    }
    renderMenu() {
    ...
    renderItems() {
        return this.items.map(item => {
            ...
            return !!item.url
                ? h("elsa-nav-link", { onClick: e => this.closeContextMenu(), url: item.url, anchorClass: `elsa-block elsa-px-4 elsa-py-2 elsa-text-sm ${selectedCssClass} elsa-cursor-pointer`, role: "menuitem" }, item.text)
...
//# sourceMappingURL=elsa-dropdown-button.entry.esm.js.map
