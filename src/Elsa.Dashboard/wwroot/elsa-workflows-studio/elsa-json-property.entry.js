...
const ElsaJsonProperty = class {
    ...
    render() {
        ...
        return (h("elsa-property-editor", { key: '213c64d44648fda15333ea9d770b970571064029', activityModel: this.activityModel, propertyDescriptor: propertyDescriptor, propertyModel: propertyModel, onDefaultSyntaxValueChanged: e => this.onDefaultSyntaxValueChanged(e), "editor-height": editorHeight, context: context }, h("elsa-monaco", { key: 'a56da0ab134d0799970a10179ed6dfc94bb09319', value: value, language: "json", "editor-height": editorHeight, onValueChanged: e => this.onMonacoValueChanged(e.detail) })));
    }
};

export { ElsaJsonProperty as elsa_json_property };
//# sourceMappingURL=elsa-json-property.entry.esm.js.map
