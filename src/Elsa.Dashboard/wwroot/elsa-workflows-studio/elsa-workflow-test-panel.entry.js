...
import { b as WorkflowStatus } from './index-D7wXd6HU.js';
...
const ElsaWorkflowTestPanel = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        const renderActivityTestMessage = () => {
            ...
            const renderEndpointUrl = () => {
                ...
                return (h("div", null, h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" }, h("dt", { class: "elsa-text-gray-500" }, h("span", { class: "elsa-mr-1" }, t('EntryEndpoint')), h("elsa-copy-button", { value: endpointUrl }))), h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" }, h("dt", { class: "elsa-text-gray-900" }, h("span", { class: "elsa-break-all font-mono", onClick: e => clip(e.currentTarget) }, endpointUrl)))));
            };
            return (h("dl", { class: "elsa-border-b elsa-border-gray-200 elsa-divide-y elsa-divide-gray-200" }, h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" }, h("dt", { class: "elsa-text-gray-500" }, t('Status')), h("dd", { class: "elsa-text-gray-900" }, workflowStatus)), renderEndpointUrl()));
        };
        return (h(Host, null, h("dl", { class: "elsa-border-b elsa-border-gray-200 elsa-divide-y elsa-divide-gray-200" }, h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" }, !this.workflowStarted ?
            ...
            :
                h("button", { type: "button", onClick: () => this.onStopWorkflowClick(), class: "elsa-ml-0 elsa-w-full elsa-inline-flex elsa-justify-center elsa-rounded-md elsa-border elsa-border-transparent elsa-shadow-sm elsa-px-4 elsa-py-2 elsa-bg-red-600 elsa-text-base elsa-font-medium elsa-text-white hover:elsa-bg-red-700 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-red-500 sm:elsa-ml-3 sm:elsa-w-auto sm:elsa-text-sm" }, t('StopWorkflow')))), renderActivityTestMessage(), h("elsa-confirm-dialog", { ref: el => this.confirmDialog = el, culture: this.culture })));
    }
    static get watchers() { return {
        "workflowTestActivityId": ["workflowTestActivityMessageChangedHandler"]
    }; }
};
Tunnel.injectProps(ElsaWorkflowTestPanel, ['serverUrl', 'culture']);

export { ElsaWorkflowTestPanel as elsa_workflow_test_panel };
//# sourceMappingURL=elsa-workflow-test-panel.entry.esm.js.map
