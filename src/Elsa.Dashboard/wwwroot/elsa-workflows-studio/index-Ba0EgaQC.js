import { a as activityIconProvider } from './elsa-client-vTNcky8U.js';
...
import { b as htmlEncode, g as getOrCreateProperty, s as setActivityModelProperty, p as parseJson } from './utils-C0M_5Llz.js';
...
var lodash_istypedarray;
var hasRequiredLodash_istypedarray;

function requireLodash_istypedarray () {
	if (hasRequiredLodash_istypedarray) return lodash_istypedarray;
	hasRequiredLodash_istypedarray = 1;
	...
	lodash_istypedarray = isTypedArray;
	return lodash_istypedarray;
}
...
var lodash__getnative;
var hasRequiredLodash__getnative;

function requireLodash__getnative () {
	if (hasRequiredLodash__getnative) return lodash__getnative;
	hasRequiredLodash__getnative = 1;
	/** `Object#toString` result references. */
	...
	lodash__getnative = getNative;
	return lodash__getnative;
}
...
var lodash_keys;
var hasRequiredLodash_keys;

function requireLodash_keys () {
	if (hasRequiredLodash_keys) return lodash_keys;
	hasRequiredLodash_keys = 1;
	var getNative = requireLodash__getnative(),
	    isArguments = requireLodash_isarguments(),
	    isArray = requireLodash_isarray();
...
var lodash__baseisequal;
var hasRequiredLodash__baseisequal;

function requireLodash__baseisequal () {
	if (hasRequiredLodash__baseisequal) return lodash__baseisequal;
	hasRequiredLodash__baseisequal = 1;
	var isArray = requireLodash_isarray(),
	    isTypedArray = requireLodash_istypedarray(),
	    keys = requireLodash_keys();
	...
	lodash__baseisequal = baseIsEqual;
	return lodash__baseisequal;
}
...
function requireLodash_isequal () {
	if (hasRequiredLodash_isequal) return lodash_isequal;
	hasRequiredLodash_isequal = 1;
	var baseIsEqual = requireLodash__baseisequal(),
	    bindCallback = requireLodash__bindcallback();
...
function requireDist () {
	...
	var _lodashIsequal = requireLodash_isequal();
    ...
    onComponentCustomButtonClick(context) {
        ...
        if (context.component === 'elsa-workflow-definition-editor-screen') {
            const activityUpdatedContext = {
                ...
                data: JSON.stringify(distExports.convert((_a = context.params[1]) === null || _a === void 0 ? void 0 : _a.Body), null, 1)
            };
...
//# sourceMappingURL=index-Ba0EgaQC.js.map
