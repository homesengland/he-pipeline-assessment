...
import { c as WorkflowTestActivityMessageStatus, a as WorkflowPersistenceBehavior } from './index-1654a48d.js';
import { f as featuresDataManager, m as monacoEditorDialogService } from './index-892f713d.js';
import { a as state } from './store-8fc2fe8a.js';
import { T as Tunnel } from './workflow-editor-eaa88887.js';
import { T as Tunnel$1 } from './dashboard-beb9b1e8.js';
import { W as WorkflowDesignerMode, L as LayoutDirection } from './models-96b27412.js';
...
const ElsaWorkflowDefinitionEditorScreen = class {
  constructor(hostRef) {
    ...
    this.workflowDesignerMode = undefined;
    this.workflowTestActivityMessages = [];
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-flex elsa-flex-col elsa-w-full", ref: el => (this.el = el) }, h(Tunnel.Provider, { state: tunnelState }, this.renderCanvas(), this.renderActivityPicker(), this.renderActivityEditor(), this.renderMonacoEditorDialog())));
  }
  renderCanvas() {
