...
import { i as initializeMonacoWorker } from './elsa-monaco-utils-670f3cf3.js';
...
import { F as FormContext, t as textInput } from './forms-cf3d2769.js';
import { s as state } from './secret.store-90bdccbb.js';
import { S as SecretEventTypes } from './secret.events-665f57c3.js';
import { a as state$1 } from './store-8fc2fe8a.js';
import { S as SyntaxNames } from './index-1654a48d.js';
import { c as createHttpClient } from './elsa-client-8304c78c.js';
...
const ElsaSecretEditorModal = class {
  constructor(hostRef) {
    ...
    this.secretModel = undefined;
    this.secretDescriptor = undefined;
    this.renderProps = {};
    this.preventClosing = undefined;
