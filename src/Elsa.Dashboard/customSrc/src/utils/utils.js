...
export function newOptionNumber(options) {
    let highestValue = 0;
...
export function newOptionLetter(options) {
    let highestValue = "A";
    if (options != null && options.length > 0) {
...
export function getOrCreateNestedProperty(activity, name, type, defaultExpression, defaultSyntax) {
...
export function filterPropertiesByType(questionProperties, questionType) {
...
export function updateNestedActivitiesByDescriptors(descriptors, properties, questionModel) {
    let newProperties = [];
...
export function createQuestionProperty(descriptor, questionModel) {
    let propertyValue = {
...
export function getExpressionMap(syntaxes) {
...
export function onUpdateCustomExpression(event, property, syntax, update) {
