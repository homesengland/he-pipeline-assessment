...
let HeCheckboxOptionProperty = class HeCheckboxOptionProperty {
    constructor() {
            ...
            return (h("tbody", { key: this.keyId },
                h("tr", null,
                    ...
                    h("td", { class: "elsa-pt-1 elsa-pr-2 elsa-text-right" },
                        h("button", { type: "button", onClick: () => this.onDeleteOptionClick(checkboxOption), class: "elsa-h-5 elsa-w-5 elsa-mx-auto elsa-outline-none focus:elsa-outline-none" },
                ...
                h("tr", { key: `case-${index}` },
                    ...
                    h("td", { class: "elsa-py-2 pl-5", colSpan: 2, style: { width: colWidth } },
                        h("div", null,
                            h("input", { type: "text", value: checkboxOption.name, onChange: e => this._base.UpdateName(e, checkboxOption), class: "focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-block elsa-w-full elsa-min-w-0 elsa-rounded-md sm:elsa-text-sm elsa-border-gray-300" })))),
                h("tr", null,
                    ...
                    h("td", { class: "elsa-py-2 pl-5", colSpan: 2, style: { width: colWidth } },
                        h("div", { class: "elsa-mt-1 elsa-relative elsa-rounded-md elsa-shadow-sm elsa-text-box" },
                            h("he-expression-editor", { key: `expression-editor-${checkboxOption.name}-${index}-${this.syntaxSwitchCount}-${this.keyId}`, ref: el => expressionEditor = el, expression: expression, language: monacoLanguage, "single-line": false, editorHeight: this.editorHeight, padding: "elsa-pt-1.5 elsa-pl-1 elsa-pr-28", onExpressionChanged: e => this._base.CustomUpdateExpression(e, checkboxOption, checkboxOption.syntax) }),
                ...
                h("tr", { style: { display: optionsDisplay } },
                    h("th", { class: "elsa-py-3 elsa-text-left elsa-text-xs elsa-font-medium elsa-text-gray-500 elsa-tracking-wider elsa-w-2/12" }, "IsSingle"),
                    h("td", { class: "elsa-py-0" },
                        h("input", { name: "choice_input", type: "checkbox", checked: checked, value: 'true', onChange: e => this._base.UpdateCheckbox(e, checkboxOption, CheckboxOptionsSyntax.Single), class: "focus:elsa-ring-blue-500 elsa-h-8 elsa-w-8 elsa-text-blue-600 elsa-border-gray-300 elsa-rounded" })),
                    h("td", null)),
                h("tr", { style: { display: optionsDisplay } },
...
__decorate([
    Prop()
], HeCheckboxOptionProperty.prototype, "activityModel", void 0);
__decorate([
    Prop()
], HeCheckboxOptionProperty.prototype, "propertyDescriptor", void 0);
__decorate([
    Prop()
], HeCheckboxOptionProperty.prototype, "propertyModel", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "keyId", void 0);
__decorate([
    Prop()
], HeCheckboxOptionProperty.prototype, "modelSyntax", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "properties", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "iconProvider", void 0);
__decorate([
    Event()
], HeCheckboxOptionProperty.prototype, "expressionChanged", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "dictionary", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "switchTextHeight", void 0);
__decorate([
    State()
], HeCheckboxOptionProperty.prototype, "editorHeight", void 0);
HeCheckboxOptionProperty = __decorate([
    Component({
        tag: 'he-checkbox-options-property',
        shadow: false,
    })
], HeCheckboxOptionProperty);
export { HeCheckboxOptionProperty };
