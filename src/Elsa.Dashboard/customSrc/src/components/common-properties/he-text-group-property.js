...
let HeTextGroupProperty = class HeTextGroupProperty {
    constructor() {
    ...
    render() {
        ...
        const renderCheckboxGroups = (textGroup) => {
            ...
            return (h("div", { class: "elsa-border-gray-300 elsa-rounded-md elsa-group-border", key: this.keyId },
                h("br", null),
                h("div", { class: "elsa-mb-1" },
                    h("div", { class: "elsa-flex" },
                        ...
                        h("div", null,
                            h("button", { type: "button", onClick: () => this.onDeleteGroupClick(textGroup), class: "elsa-h-5 elsa-w-5 elsa-mx-auto elsa-outline-none focus:elsa-outline-none" },
                                h(TrashCanIcon, { options: this.iconProvider.getOptions() })))),
                    h("br", null),
                    h("div", { style: { display: displayGroupStyle } },
                        h("div", { class: "elsa-mb-1" },
                            h("div", { class: "elsa-flex" },
                                h("div", { class: "elsa-flex-1" },
                                    h("label", { class: "elsa-block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, "Title")))),
                        h("div", null,
                            h("div", null,
                                h("input", { type: "text", value: title, onChange: e => this._base.StandardUpdateExpression(e, textGroup, TextActivityOptionsSyntax.Title), class: "focus:elsa-ring-blue-500 focus:elsa-border-bue-500 elsa-block elsa-w-full elsa-min-w-0 elsa-rounded-md sm:elsa-text-sm elsa-border-gray-300" })),
                            h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "The title of the text grouping.  This can be left empty, but if a value is given, it will display as a heading.")),
                        h("br", null),
                        h("div", { class: "elsa-mb-1" },
                            h("div", { class: "elsa-flex" },
                                h("div", { class: "elsa-flex-1" },
                                    h("label", { class: "elsa-block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, "Display on Page")))),
                        h("div", { class: "elsa-relative" },
                            h("he-expression-editor", { key: `expression-editor-${this.syntaxSwitchCount}`, ref: el => conditionExpressionEditor = el, expression: conditionExpression, language: conditionLanguage, "single-line": false, editorHeight: conditionEditorHeight, padding: "elsa-pt-1.5 elsa-pl-1 elsa-pr-28", onExpressionChanged: e => this._base.CustomUpdateExpression(e, textGroup, TextActivityOptionsSyntax.Condition) }),
                        ...
                        h("div", { class: "elsa-mb-1" },
                            h("div", { class: "elsa-flex" },
                                h("div", { class: "elsa-flex-1" },
                                    h("label", { class: "elsa-block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, "Is Guidance")))),
                        h("div", null,
                            h("div", null,
                                h("input", { type: "checkbox", checked: isGuidanceChecked, onChange: e => this._base.UpdateCheckbox(e, textGroup, TextActivityOptionsSyntax.Guidance), class: "focus:elsa-ring-blue-500 elsa-h-8 elsa-w-8 elsa-text-blue-600 elsa-border-gray-300 elsa-rounded" })),
                            h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "Should the group of text be wrapped in a guidance block.")),
                        h("br", null),
                        h("div", { class: "elsa-mb-1" },
                            h("div", { class: "elsa-flex" },
                                h("div", { class: "elsa-flex-1" },
                                    h("label", { class: "elsa-block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, "Is Collapsed")))),
                        h("div", null,
                            h("div", null,
                                h("input", { type: "checkbox", checked: isCollapsedChecked, onChange: e => this._base.UpdateCheckbox(e, textGroup, TextActivityOptionsSyntax.Collapsed), class: "focus:elsa-ring-blue-500 elsa-h-8 elsa-w-8 elsa-text-blue-600 elsa-border-gray-300 elsa-rounded" })),
                            h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "Should the group of text be hidden by default, behind a collapseable element. Users will still be able to see the text by clicking to view the hidden text.")),
                        h("br", null),
                        h("div", { class: "elsa-mb-1" },
                            h("div", { class: "elsa-flex" },
                                h("div", { class: "elsa-flex-1" },
                                    h("label", { class: "elsa-block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, "Is Bulletpointed")))),
                        h("div", null,
                            h("div", null,
                                h("input", { type: "checkbox", checked: isBulletsChecked, onChange: e => this._base.UpdateCheckbox(e, textGroup, TextActivityOptionsSyntax.Bulletpoints), class: "focus:elsa-ring-blue-500 elsa-h-8 elsa-w-8 elsa-text-blue-600 elsa-border-gray-300 elsa-rounded" })),
                            h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "Each paragraph of text will be displayed as a bullet-point list within this group.")))),
                h("he-text-activity-property", { activityModel: this.activityModel, propertyModel: textGroup, propertyDescriptor: descriptor, onExpressionChanged: e => eventHandler(e, textGroup), modelSyntax: SyntaxNames.TextActivity, style: { display: displayGroupStyle } }),
                h("br", null),
                h("hr", null)));
        };
        const context = {
        ...
        return (h("div", null,
            h("he-multi-expression-editor", { ref: el => this.multiExpressionEditor = el, label: this.propertyDescriptor.label, hint: this.propertyDescriptor.hint, defaultSyntax: SyntaxNames.Json, supportedSyntaxes: [SyntaxNames.Json], context: context, expressions: { 'Json': json }, "editor-height": "20rem", onExpressionChanged: e => this.onMultiExpressionEditorValueChanged(e), onSyntaxChanged: e => this.onMultiExpressionEditorSyntaxChanged(e) },
                h("hr", null),
                h("div", { class: "elsa-min-w-full elsa-divide-y elsa-divide-gray-200", ref: el => (this.container = el) }, textGroups.map(renderCheckboxGroups)),
...
__decorate([
    Prop()
], HeTextGroupProperty.prototype, "activityModel", void 0);
__decorate([
    Prop()
], HeTextGroupProperty.prototype, "propertyDescriptor", void 0);
__decorate([
    Prop()
], HeTextGroupProperty.prototype, "propertyModel", void 0);
__decorate([
    Prop()
], HeTextGroupProperty.prototype, "modelSyntax", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "keyId", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "properties", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "iconProvider", void 0);
__decorate([
    Event()
], HeTextGroupProperty.prototype, "expressionChanged", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "dictionary", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "switchTextHeight", void 0);
__decorate([
    State()
], HeTextGroupProperty.prototype, "editorHeight", void 0);
HeTextGroupProperty = __decorate([
    Component({
        tag: 'he-text-group-property',
        shadow: false,
    })
], HeTextGroupProperty);
export { HeTextGroupProperty };
