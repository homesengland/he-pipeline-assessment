...
let CustomElsaSwitchCasesProperty = class CustomElsaSwitchCasesProperty {
    constructor() {
        this.cases = [];
            ...
            return (h("tr", { key: `case-${index}` },
                ...
                h("td", { class: "elsa-py-2 pl-5" },
                    h("div", { class: "elsa-mt-1 elsa-relative elsa-rounded-md elsa-shadow-sm elsa-text-box" },
                        h("he-expression-editor", { key: `expression-editor-${index}-${this.syntaxSwitchCount}`, ref: el => expressionEditor = el, expression: expression, language: monacoLanguage, "single-line": false, editorHeight: this.editorHeight, padding: "elsa-pt-1.5 elsa-pl-1 elsa-pr-28", serverUrl: "https://localhost:7227", onExpressionChanged: e => this.onCaseExpressionChanged(e, switchCase) }),
...
__decorate([
    Prop()
], CustomElsaSwitchCasesProperty.prototype, "activityModel", void 0);
__decorate([
    Prop()
], CustomElsaSwitchCasesProperty.prototype, "propertyDescriptor", void 0);
__decorate([
    Prop()
], CustomElsaSwitchCasesProperty.prototype, "propertyModel", void 0);
__decorate([
    State()
], CustomElsaSwitchCasesProperty.prototype, "cases", void 0);
__decorate([
    State()
], CustomElsaSwitchCasesProperty.prototype, "iconProvider", void 0);
__decorate([
    State()
], CustomElsaSwitchCasesProperty.prototype, "switchTextHeight", void 0);
__decorate([
    State()
], CustomElsaSwitchCasesProperty.prototype, "editorHeight", void 0);
CustomElsaSwitchCasesProperty = __decorate([
    Component({
        tag: 'switch-answers-property',
        shadow: false,
    })
], CustomElsaSwitchCasesProperty);
export { CustomElsaSwitchCasesProperty };
