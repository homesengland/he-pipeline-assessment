...
let HePotScoreRadioOptionProperty = class HePotScoreRadioOptionProperty {
    constructor() {
        this.properties = [];
    ...
    render() {
        ...
        const renderCaseEditor = (radioOption, index) => {
            ...
            return (h("tbody", { key: this.keyId },
                ...
                h("tr", null,
                    h("th", { class: "elsa-py-3 elsa-text-left elsa-text-xs elsa-font-medium elsa-text-gray-500 elsa-tracking-wider elsa-w-2/12" }, "Pot Score"),
                    h("td", { class: "elsa-py-2", style: { width: colWidth } },
                        h("select", { onChange: e => this._base.UpdateDropdown(e, radioOption, RadioOptionsSyntax.PotScore), class: "elsa-mt-1 elsa-block focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-w-full elsa-shadow-sm sm:elsa-max-w-xs sm:elsa-text-sm elsa-border-gray-300 elsa-rounded-md" }, this.potScoreOptions.map(potScore => {
...
__decorate([
    Prop()
], HePotScoreRadioOptionProperty.prototype, "activityModel", void 0);
__decorate([
    Prop()
], HePotScoreRadioOptionProperty.prototype, "propertyDescriptor", void 0);
__decorate([
    Prop()
], HePotScoreRadioOptionProperty.prototype, "propertyModel", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "keyId", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "properties", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "iconProvider", void 0);
__decorate([
    Event()
], HePotScoreRadioOptionProperty.prototype, "expressionChanged", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "dictionary", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "switchTextHeight", void 0);
__decorate([
    State()
], HePotScoreRadioOptionProperty.prototype, "editorHeight", void 0);
HePotScoreRadioOptionProperty = __decorate([
    Component({
        tag: 'he-potscore-radio-options-property',
        shadow: false,
    })
], HePotScoreRadioOptionProperty);
export { HePotScoreRadioOptionProperty };
