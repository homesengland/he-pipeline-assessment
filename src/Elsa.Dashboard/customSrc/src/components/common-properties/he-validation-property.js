...
let HeValidationProperty = class HeValidationProperty {
    constructor() {
            ...
            return (h("tbody", { key: this.keyId },
                h("tr", null,
                    ...
                    h("td", { class: "elsa-pt-1 elsa-pr-2 elsa-text-right" },
                        h("button", { type: "button", onClick: () => this.onHandleDelete(validationRule), class: "elsa-h-5 elsa-w-5 elsa-mx-auto elsa-outline-none focus:elsa-outline-none" },
                            h(TrashCanIcon, { options: this.iconProvider.getOptions() })))),
                h("tr", null,
                    h("th", { class: "elsa-px-6 elsa-py-3 elsa-text-left elsa-text-xs elsa-font-medium elsa-text-gray-500 elsa-tracking-wider elsa-w-2/12" }, "Validation Rule"),
                    h("td", { class: "elsa-py-2 pl-5", colSpan: 2, style: { width: colWidth } },
                        h("div", { class: "elsa-mt-1 elsa-relative elsa-rounded-md elsa-shadow-sm" },
                            h("he-expression-editor", { key: `expression-editor-${index}-${this.syntaxSwitchCount}`, ref: el => ruleExpressionEditor = el, expression: ruleExpression, language: ruleLanguage, context: textContext, "single-line": false, editorHeight: "2.75em", padding: "elsa-pt-1.5 elsa-pl-1 elsa-pr-28", onExpressionChanged: e => this._base.CustomUpdateExpression(e, validationRule, ValidationSyntax.ValidationRule) })),
                        h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "The validation rule to evaluate for this question.  This must be written in Javascript, and will default to \"true\" if left blank."),
                        h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, "Rules that evaluate as true will pass validation, and rules that evaluate as false will fail, and display the validation message below."))),
                h("tr", null,
                    h("th", { class: "elsa-px-6 elsa-py-3 elsa-text-left elsa-text-xs elsa-font-medium elsa-text-gray-500 elsa-tracking-wider elsa-w-2/12" }, "Validation Message"),
                    h("td", { class: "elsa-py-2 pl-5", colSpan: 2, style: { width: colWidth } },
                        h("div", { class: "elsa-mt-1 elsa-relative elsa-rounded-md elsa-shadow-sm" },
                            h("he-expression-editor", { key: `expression-editor-${index}-${this.syntaxSwitchCount}`, ref: el => errorMessageExpressionEditor = el, expression: errorMessageExpression, language: errorLanguage, "single-line": false, editorHeight: conditionEditorHeight, padding: "elsa-pt-1.5 elsa-pl-1 elsa-pr-28", onExpressionChanged: e => this._base.CustomUpdateExpression(e, validationRule, errorMessageSyntax) }),
...
__decorate([
    Prop()
], HeValidationProperty.prototype, "activityModel", void 0);
__decorate([
    Prop()
], HeValidationProperty.prototype, "propertyDescriptor", void 0);
__decorate([
    Prop()
], HeValidationProperty.prototype, "propertyModel", void 0);
__decorate([
    Prop()
], HeValidationProperty.prototype, "modelSyntax", void 0);
__decorate([
    State()
], HeValidationProperty.prototype, "properties", void 0);
__decorate([
    State()
], HeValidationProperty.prototype, "iconProvider", void 0);
__decorate([
    State()
], HeValidationProperty.prototype, "keyId", void 0);
__decorate([
    Event()
], HeValidationProperty.prototype, "expressionChanged", void 0);
__decorate([
    State()
], HeValidationProperty.prototype, "dictionary", void 0);
HeValidationProperty = __decorate([
    Component({
        tag: 'he-validation-property',
        shadow: false,
    })
], HeValidationProperty);
export { HeValidationProperty };
