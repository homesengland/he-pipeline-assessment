...
namespace Elsa.CustomWorkflow.Sdk.Tests.Workflow.Validators
{
    public class IntegerValidatorTests
    {
        ...
        public void Should_Have_Error_When_AnswerIsNull()
        {
            ...
            result.ShouldHaveValidationErrorFor(c => c.Answers).WithErrorMessage("The answer must be a whole number. If none, please enter 0.");
        }
        ...
        public void Should_Have_Errors_When_AnswerIsNotANumber()
        {
            ...
            //Assert
            result.ShouldNotHaveValidationErrorFor(c => c);
            result.ShouldHaveValidationErrorFor(c => c.Answers).WithErrorMessage("The answer MyAnswer must be a whole number. If none, please enter 0");
        }
        ...
        public void Should_Have_Errors_When_AnswerIsADecimal()
        {
            ...
            //Assert
            result.ShouldHaveValidationErrorFor(c => c.Answers).WithErrorMessage("The answer 1234.567 must be a whole number. If none, please enter 0"); ;
        }
