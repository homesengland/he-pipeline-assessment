...
{
    public class MockAssessmentConfiguration : IEntityTypeConfiguration<Assessment>
    {
        private bool _useSeedData = false;
        private AssessmentStubData _dataGenerator;
        public MockAssessmentConfiguration(IConfiguration config, AssessmentStubData dataGenerator)
        {
