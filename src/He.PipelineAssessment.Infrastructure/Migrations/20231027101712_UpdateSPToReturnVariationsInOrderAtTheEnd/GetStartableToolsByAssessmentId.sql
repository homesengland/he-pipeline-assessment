...
AS
BEGIN
    SELECT ATW.AssessmentToolId, ATW.Id as AssessmentToolWorkflowId, ATW.WorkflowDefinitionId, ATW.IsFirstWorkflow, NW.IsVariation
    ...
    SELECT ATW.AssessmentToolId, ATW.Id as AssessmentToolWorkflowId, ATW.WorkflowDefinitionId, ATW.IsFirstWorkflow, ATWI.IsVariation
