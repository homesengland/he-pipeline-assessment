...
BEGIN
	...
	ISNULL((
		...
		from [AssessmentToolWorkflowInstance] atwi 
		inner join AssessmentToolWorkflow atw on atw.WorkflowDefinitionId = atwi.WorkflowDefinitionId and atw.Status !=''Deleted''
		inner join AssessmentTool at on at.Id = atw.AssessmentToolId and at.Status !=''Deleted''
		where a.Id = atwi.AssessmentId 
