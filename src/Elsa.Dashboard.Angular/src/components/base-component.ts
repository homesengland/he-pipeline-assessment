// import { Component, Output, EventEmitter, Input, ModelSignal, output, input } from '@angular/core';
...
//   activityModel: ModelSignal<ActivityModel>;
//   propertyDescriptor: ModelSignal<ActivityPropertyDescriptor>;
//   propertyModel: ModelSignal<ActivityDefinitionProperty>;
//   modelSyntax: string;
