...
namespace Elsa.Server.Tests.Services
{
    public class DeleteChangedWorkflowPathServiceTests
    {
            ...
            DeleteChangedWorkflowPathService sut)
        {
            ...
            elsaCustomRepository.Verify(
                x => x.DeleteQuestions(customActivityNavigation.WorkflowInstanceId, previousPathActivities, CancellationToken.None), Times.Once);
        }
            ...
            DeleteChangedWorkflowPathService sut)
        {
            ...
            elsaCustomRepository.Verify(
                x => x.DeleteQuestions(workflowInstanceId,
